...
def seed_rpg_systems():
    ...
    races = {
        "Dungeons & Dragons 5th Edition": [
            {"name": "Elf", "description": "A magical race with keen senses, powerful magic, and a natural affinity for nature.", "size": "Medium", "speed": 30},
            {"name": "Dwarf", "description": "A stout and sturdy race known for their craftsmanship and battle prowess.", "size": "Medium", "speed": 25},
            {"name": "Human", "description": "A versatile and adaptable race, excelling in various fields of life.", "size": "Medium", "speed": 30},
            {"name": "Halfling", "description": "A small, nimble race known for their courage and resourcefulness.", "size": "Small", "speed": 25},
            {"name": "Dragonborn", "description": "A proud and honorable race with dragon ancestry, capable of breathing elemental energy.", "size": "Medium", "speed": 30},
            {"name": "Gnome", "description": "A small, curious race with a love for invention and discovery.", "size": "Small", "speed": 25},
            {"name": "Half-Elf", "description": "A race with both human and elven ancestry, combining the best traits of both.", "size": "Medium", "speed": 30},
            {"name": "Half-Orc", "description": "A race with human and orc ancestry, known for their strength and resilience.", "size": "Medium", "speed": 30},
            {"name": "Tiefling", "description": "A race with infernal heritage, marked by their demonic appearance and dark powers.", "size": "Medium", "speed": 30}
        ],
        "Pathfinder": [
            {"name": "Elf", "description": "A race of scholars and archers, known for their long lifespan and connection to nature.", "size": "Medium", "speed": 30},
            {"name": "Dwarf", "description": "A sturdy race with a deep connection to the earth, excelling in mining and crafting.", "size": "Medium", "speed": 25},
            {"name": "Human", "description": "A race known for their adaptability and diversity, thriving in various environments.", "size": "Medium", "speed": 30},
            {"name": "Halfling", "description": "A small and nimble race, known for their bravery and luck.", "size": "Small", "speed": 25},
            {"name": "Goblin", "description": "A mischievous and resourceful race, often underestimated due to their small size.", "size": "Small", "speed": 25},
            {"name": "Gnome", "description": "A curious and inventive race, deeply connected to the world of magic.", "size": "Small", "speed": 25},
            {"name": "Half-Elf", "description": "A race that bridges the gap between humans and elves, possessing traits of both.", "size": "Medium", "speed": 30},
            {"name": "Half-Orc", "description": "A race that combines the strength of orcs with the versatility of humans.", "size": "Medium", "speed": 30}
        ],
        "Call of Cthulhu": [
            {"name": "Human", "description": "The primary race in the world of Call of Cthulhu, driven by curiosity, fear, and resilience.", "size": "Medium", "speed": 30},
            {"name": "Deep One Hybrid", "description": "A human tainted by the blood of the Deep Ones, often showing signs of their aquatic ancestry.", "size": "Medium", "speed": 30},
            {"name": "Ghoul", "description": "A once-human creature transformed into a monstrous cannibal by the horrors of the Mythos.", "size": "Medium", "speed": 30}
        ],
        "Shadowrun": [
            {"name": "Human", "description": "The most common race, known for their adaptability and ambition.", "size": "Medium", "speed": 30},
            {"name": "Elf", "description": "A graceful and agile race with an affinity for magic and technology.", "size": "Medium", "speed": 30},
            {"name": "Ork", "description": "A strong and resilient race, often marginalized in society but possessing great potential.", "size": "Medium", "speed": 30},
            {"name": "Dwarf", "description": "A short but sturdy race, excelling in technical fields and engineering.", "size": "Small", "speed": 25},
            {"name": "Troll", "description": "A massive and powerful race, often feared due to their size and strength.", "size": "Large", "speed": 25}
        ],
        "Star Wars":[
            {"name": "Human", "description": "The most widespread species in the galaxy, known for their diversity and ambition.", "size": "Medium", "speed": 30},
            {"name": "Twi'lek", "description": "A race known for their distinctive head-tails and strong sense of community.", "size": "Medium", "speed": 30},
            {"name": "Wookiee", "description": "A tall and powerful species from the forested planet Kashyyyk, known for their strength and loyalty.", "size": "Medium", "speed": 30},
            {"name": "Rodian", "description": "A green-skinned species known for their tracking and hunting skills.", "size": "Medium", "speed": 30},
            {"name": "Bothan", "description": "A furred species known for their intelligence and skills in espionage.", "size": "Medium", "speed": 30}
        ],
        "Mothership RPG": [
            {"name": "Human", "description": "The standard race in the universe of Mothership, facing the dangers of deep space.", "size": "Medium", "speed": 30},
            {"name": "Android", "description": "A synthetic lifeform designed to assist humans, often indistinguishable from their creators.", "size": "Medium", "speed": 30}
        ]
    }
