...
const Navbar = ({ onLogout }) => {
    ...
    <nav className="bg-primary p-4 shadow-md">
        ...
        <div className="container mx-auto flex justify-between items-center">
            ...
            <div>
                <Link to="/dashboard">
                    <button className="text-accent text-3xl font-bold hover:text-text transition duration-300">
                    RPG Nexus
                    </button>
                </Link>
            </div>
            <div className="flex space-x-6">
                ...
                >
                    ...
                    {showSystemsDropdown && (
                        ...
                        <Link to="/rpgsystems" className="block text-text hover:text-accent">View Systems</Link>
